			...
			<div class="weui-form-preview">
				...
				<div class="weui-form-preview__ft">
					<a class="weui-form-preview__btn weui-form-preview__btn_default"
						href="${pageContext.request.contextPath }/s/in/exam/list?courseId=${me.id}">课堂测验情况</a>
					<button type="submit"
						class="weui-form-preview__btn weui-form-preview__btn_primary"
						href="${pageContext.request.contextPath }/s/in/course/close?courseId=${me.id}">结束课程</button>
				</div>
			</div>
