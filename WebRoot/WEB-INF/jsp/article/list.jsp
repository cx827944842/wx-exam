                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
	                        	<button type="button" onclick="send()" class="btn btn-primary">发送选中图文消息</button>
	                        	<button type="button" onclick="create()" class="btn btn-default">上传选中图文素材</button>
								<button type="button" onclick="del()" class="btn btn-danger">删除选中</button>
                        </div>
                        <script type="text/javascript">
                        	function create() {
                        		 $("#form").attr("action","${pageContext.request.contextPath}/s/news/add");
                        		 $("#form").submit();
							}
                        	function send() {
                        		 $("#form").attr("action","${pageContext.request.contextPath}/s/news/send");
                        		 $("#form").submit();
							}
                        	function del() {
                        		 $("#form").attr("action","${pageContext.request.contextPath}/s/article/muldelte");
                        		 $("#form").submit();
							}
                        </script>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	...
                                	<c:forEach items="${articleList}" var="me">
	                                    ...
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>${me.author}</td>
	                                        <td>${me.digest}</td>
	                                        <td class="center">${me.showCoverPic}</td>
	                                        <td class="center">${me.time}</td>
	                                        <td></td>
	                                    </tr>
                                	</c:forEach>
                                </tbody>
