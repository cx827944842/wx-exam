                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
	                        	<button type="button" onclick="recommend()" class="btn btn-primary">推荐选中商品</button>
	                        	<button type="button" onclick="hot()" class="btn btn-default">选中标为热门</button>
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	...
                                	<c:forEach items="${imageList}" var="me">
