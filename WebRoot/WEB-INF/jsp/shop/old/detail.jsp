...
<body>
    <div class="body">
        <figure>
            ...
            <div class="info" style="height:25px">
                <span class="sat" style="color:red;padding-left:10px">￥${item.price }</span>
            </div>
        </figure>
        ...
        <div style="margin-top: 20px; background-color:#EEEEEE;height:10px"></div>
        <div class="" style="margin-top:10px;height:20px;" >
         ...
         <span style = "float:right;margin-right:10px; ">>></span>
                     ...
                     <div  style="margin-top: 10px; background-color:#EEEEEE;height:40px;text-align:center; "><p style="line-height:40px ">更多精选商品</p></div>
    ...
    <div style="padding-left:2% ">
	    <c:forEach items="${items }" var="me" >
	        ...
	        <figure class="gengduo " style="border: none; ">
    ...
    <div style="margin-top: 10px; background-color:white;height:40px;text-align:center;clear:both; "><p style="line-height:40px "><a href="${pageContext.request.contextPath }">进入店铺>></a></p></div>
    </div>
